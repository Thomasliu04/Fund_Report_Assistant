...
def _readme_sheet(wb: Workbook, period_label: str) -> None:
    ...
    lines = [
        ...
        "2. 默认流程不自动贴表：在 PPT 右侧占位处，从本文件对应 sheet 复制表图粘贴",
        "3. 建议：选中表格区域 → 复制 → 粘贴到 PPT（保留源格式 / 图片均可，按公司规范）",
        "4. 数字一般不要手改；若底稿更新请重新跑生成流程",
        "",
        "【数据条】",
        "正值向右红色，负值向左绿色（与案例表图一致）；轴在零点。",
        "",
        "【终表 sheet → PPT 页（粘贴清单）】",
        "01_行业变化          → PPT 第 1 页表",
        "02_总规模            → PPT 第 2 页表",
        ...
        "04_非货增量          → PPT 第 4 页表",
        "05_主动权益          → PPT 第 5 页表",
        "06_非货ETF含联接     → PPT 第 6 页【左侧】",
        "06_权益ETF含联接     → PPT 第 6 页【右侧】",
        "07_货币              → PPT 第 7 页表",
        "08_固收              → PPT 第 8 页表",
        "09_固收+             → PPT 第 9 页表",
        "10_FOF               → PPT 第 10 页表",
        "",
        "【ETF 易错】",
        "· 第 6 页左右都是「含联接」口径；不要贴名为「不含联接」的旧 sheet。",
        "· 左=非货 ETF 含联接；右=权益 ETF 含联接。",
        "",
        "【数据来源】",
